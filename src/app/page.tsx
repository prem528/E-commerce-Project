import Navbar from "@/customComponents/homePage/navbar";
...
export default function Home() {
  return (
    <div className="max-w-screen">
      ...
      {/* CATEGORY */}
      <div className="w-[50%] mx-auto mt-8 border-black py-3 border-t-2 border-b-2">
        {/* BUTTONS DIV */}
        <div className="w-full flex justify-between">
          <span className="bg-[#E6D5C7] px-8 py-1 rounded-full text-xl font-semibold">
            HOME
          </span>
          <span className="bg-[#E6D5C7] px-8 py-1 rounded-full text-xl font-semibold">
            FURNITURE
